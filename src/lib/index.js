...
class Player extends React.Component {
	...
	_execPlayVideo(){
		...
		let startingTime = this._player.getCurrentTime()
		...
		return (
			...
			<div style={{position: 'relative'}}>
				<div style={{marginRight: '50px'}}>
					<h3 style={titleStyle}>Some Title</h3>
					<h4 style={authorStyle}>Some Band</h4>
					<h5 style={collectionStyle}>Some Collection</h5>
				</div>
